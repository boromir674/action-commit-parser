...
from action_commit_parser import __version__

this_file_location = os.path.dirname(os.path.realpath(os.path.abspath(__file__)))


def version_msg():
    """action_commit_parser version, location and Python version.

    Get message about action_commit_parser version, location
    and Python version.
    """
    python_version = sys.version[:3]
    message = u"Action Commit Parser %(version)s from {} (Python {})"
